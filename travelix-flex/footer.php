	...
	<footer class="footer" id="site-footer">
		<div class="container">
			<div class="footer__grid">
				...
				<div><h2 class="footer__title"><?php echo esc_html( travelix_flex_text( 'footer_services_title' ) ); ?></h2><?php wp_nav_menu( array( 'theme_location' => 'footer_services', 'container' => false, 'menu_class' => 'footer__menu', 'fallback_cb' => false, 'depth' => 1 ) ); ?><ul class="footer__contact"><li><?php echo travelix_flex_icon( 'phone' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?><a href="tel:<?php echo esc_attr( travelix_flex_tel_href() ); ?>"><bdi dir="ltr"><?php echo esc_html( travelix_flex_text( 'phone' ) ); ?></bdi></a></li><li><?php echo travelix_flex_icon( 'mail' ); // phpcs:ignore WordPress.Security.EscapeOutput.OutputNotEscaped ?><a href="mailto:<?php echo esc_attr( antispambot( travelix_flex_option( 'email' ) ) ); ?>"><bdi dir="ltr"><?php echo esc_html( antispambot( travelix_flex_option( 'email' ) ) ); ?></bdi></a></li></ul></div>
			...
			<div class="footer__bottom"><span><bdi>© <?php echo esc_html( wp_date( 'Y' ) ); ?> <?php bloginfo( 'name' ); ?></bdi> — <?php echo esc_html( travelix_flex_text( 'footer_copyright' ) ); ?></span><?php wp_nav_menu( array( 'theme_location' => 'legal', 'container' => false, 'menu_class' => 'footer__legal', 'fallback_cb' => false, 'depth' => 1 ) ); ?></div>
		</div>
	</footer>
<?php endif; ?>
<?php wp_footer(); ?>
